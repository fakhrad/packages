...
export default class MyRequests extends BaseComponent {
  ...
  componentDidMount = () => {
    ...
    navManager.registerScreen(undefined, "OrderDetail", OrderDetail);
  ...
  _renderItem = (rowData, rowMap) => {
    ...
    return (
      <Item
        ...
        onDetailPressed={selectedItem => this.showOrderDetail(selectedItem)}
      />
    );
  };
        ...
        <Header style={styles.header}>
          <Container style={styles.headerActions}>
            ...
            <Text style={styles.headerText}>
              {languageManager.translate(this, "MY_ORDERS_HEADER_TITLE")}
            </Text>
          </Container>
        </Header>
        <FlatList
