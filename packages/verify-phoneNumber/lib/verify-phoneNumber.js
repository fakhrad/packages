...
import { Container, Input, Button, Text, ApiButton } from "@app-sdk/components"; // public components
...
export default class LoginVerify extends React.Component {
    constructor(props) {
        ...
        stateManager.instance.registerFormState(this, {
            phoneNumber:
                props.inputs != undefined ? props.inputs.phoneNumber : undefined,
            code: null
        });
        this.state = {
            code: "",
    ...
    componentDidMount() {
        setTimeout(() => {
            Alert.alert("Activation code is: " + this.props.outputs.activation_code);
        }, 1000);
    }
    ...
    render() {
        return <Container style={styles.wrapper}>
            ...
            <Container style={styles.codeContainer} animation="fadeIn">
                <Input style={styles.verifyInput} maxLength={1} editable={false} defaultValue={this.state.input1} />
                <Input style={styles.verifyInput} maxLength={1} editable={false} onTextChange={this.generateCode} defaultValue={this.state.input2} />
                <Input style={styles.verifyInput} maxLength={1} editable={false} onTextChange={this.generateCode} defaultValue={this.state.input3} />
                <Input style={styles.verifyInput} maxLength={1} editable={false} onTextChange={this.generateCode} defaultValue={this.state.input4} />
            </Container>
            ...
            <Container style={styles.numKeyContainer} animation="fadeInUp" delay={40}>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("1")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(1)}</Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("2")}>
                    <Text style={styles.numKeyBtnText}>
                        {languageManager.translate(this, "NUMBER_2")}
                    </Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("3")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(3)}</Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("4")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(4)}</Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("5")}>
                    <Text style={styles.numKeyBtnText}>
                        {languageManager.translate(this, "NUMBER_5")}
                    </Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("6")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(6)}</Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("7")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(7)}</Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("8")}>
                    <Text style={styles.numKeyBtnText}>
                        {languageManager.translate(this, "NUMBER_8")}
                    </Text>
                </Button>
                <Button style={styles.numKeyBtn} onPress={() => this.onPressNumKey("9")}>
                    <Text style={styles.numKeyBtnText}>{this.getKeyNumber(9)}</Text>
                </Button>
                <Button style={[styles.numKeyBtn]} onPress={() => this.onPressNumKey("remove")}>
                    <Icon name="angle-double-left" style={styles.numKeyBtnIcon} />
                </Button>
                <Button style={[styles.numKeyBtn]} onPress={() => this.onPressNumKey("0")}>
                    <Text style={[styles.numKeyBtnText, { alignSelf: "center" }]}>
                        {languageManager.translate(this, "NUMBER_0")}
                    </Text>
                </Button>
                <ApiButton style={[styles.numKeyBtn]} action={{ api: "authentication", func: "verifyCode" }} onOk={res => {
